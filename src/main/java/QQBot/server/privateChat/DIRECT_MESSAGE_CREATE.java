package QQBot.server.privateChat;
...
//私聊
public class DIRECT_MESSAGE_CREATE {
    //    处理邮件消息
    public void Mail_User(privateChatModel group) {
    ...
    //        发送消息频道
    public void message(privateChatModel group, String message){
        try {
            ...
            //         创建连接并设置请求头和请求体
            Connection connection = Jsoup.connect("https://api.sgroup.qq.com/dms/"+group.getGuild_id()+"/messages")
